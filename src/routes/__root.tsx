...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vrixora — Soluciones digitales" },
      { name: "description", content: "Vrixora desarrolla soluciones digitales.  Descubre TukTuk, la app para controlar ingresos, gastos, kilometraje y mantenimientos." },
      { name: "author", content: "Vrixora" },
      { property: "og:title", content: "Vrixora — Soluciones digitales" },
      { property: "og:description", content: "Vrixora desarrolla soluciones digitales.  Descubre TukTuk, la app para controlar ingresos, gastos, kilometraje y mantenimientos." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Vrixora" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Vrixora — Soluciones digitales" },
      { name: "twitter:description", content: "Vrixora desarrolla soluciones digitales.  Descubre TukTuk, la app para controlar ingresos, gastos, kilometraje y mantenimientos." },
