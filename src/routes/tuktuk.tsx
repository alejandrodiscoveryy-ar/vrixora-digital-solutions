  ...
  return (
    <div>
        ...
        <div className="grid items-center gap-8 md:grid-cols-2 md:gap-12">
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground sm:mt-4">
              Un producto de <Link to="/soluciones" className="text-primary underline">Vrixora Solutions</Link>.
            </p>
            <p className="mt-4 text-base text-muted-foreground sm:mt-6 sm:text-lg">
              TukTuk Control es una aplicación desarrollada por Vrixora Solutions para ayudar a propietarios y
              conductores de triciclos eléctricos a registrar y gestionar ingresos, gastos, kilometraje, voltaje de
              batería, mantenimientos, licencias y estadísticas desde un solo lugar. También permite trabajar sin
            ...
            <div className="mt-6 flex flex-wrap gap-2 sm:mt-8 sm:gap-3">
              ...
              <Link to="/terminos" className="rounded-lg border border-border px-3 py-2 text-xs hover:bg-accent hover:text-accent-foreground sm:px-4 sm:text-sm">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16 sm:px-6 sm:pb-20">
        <h2 className="text-2xl font-bold md:text-3xl">Funciones de TukTuk Control</h2>
